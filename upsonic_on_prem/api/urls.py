...
user_urs = [get_dump_user_of_scope_url, get_dump_time_of_scope_url, get_dump_difference_of_scope_url, dump_run_url, get_last_runs_url, create_readme_url, get_openai_api_key_user, get_default_ai_model, get_readme_url, get_readme_github_sync_url, load_url, dump_url, get_read_scopes_of_me_url, get_write_scopes_of_me_url, get_github_sync_of_scope_url, get_document_of_scope_url, get_settings_of_scope_url, get_requirements_of_scope_url, get_security_analysis_of_scope_url, get_required_test_types_of_scope_url, get_tags_of_scope_url, get_mistakes_of_scope_url, get_time_complexity_of_scope_url,
            ...
            get_all_scopes_user_url, delete_scope_url,delete_version_url, dump_code_url, dump_requirements_url, dump_settings_url, dump_python_version_url, dump_type_url, get_version_history_url, get_module_version_history_url, get_version_code_of_scope_url, get_version_time_of_scope_url, get_version_difference_of_scope_url, get_code_of_scope_url]
...
user_read_urls = [get_dump_user_of_scope_url, get_dump_time_of_scope_url, get_dump_difference_of_scope_url, get_last_runs_url, load_url, get_document_of_scope_url, get_github_sync_of_scope_url, get_requirements_of_scope_url, get_settings_of_scope_url, get_security_analysis_of_scope_url, get_required_test_types_of_scope_url, get_tags_of_scope_url, get_mistakes_of_scope_url, get_time_complexity_of_scope_url, get_dump_history_url, get_type_of_scope_url, get_python_version_of_scope_url,
                  load_specific_dump_url,load_specific_version_url, get_version_history_url, get_version_code_of_scope_url, get_version_difference_of_scope_url, get_version_time_of_scope_url, get_code_of_scope_url]
