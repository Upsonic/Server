from upsonic_on_prem.api.endpoints import scope_read_auth_endpoints
from upsonic_on_prem.api.endpoints import scope_write_auth_endpoints
from upsonic_on_prem.api.endpoints import user_urls_endpoints
