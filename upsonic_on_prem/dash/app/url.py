...
urlpatterns = [
    ...
    path('set_openai_api_key_user/<id>', views.set_openai_api_key_user, name="set_openai_api_key_user"),
    path('delete_openai_api_key_user/<id>', views.delete_openai_api_key_user, name="delete_openai_api_key_user"),
